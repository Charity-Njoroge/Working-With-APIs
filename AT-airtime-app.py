...
import json
from africastalking.Service import APIService, validate_amount, validate_phone
...
class AirtimeService(APIService):
    ...
    def send(self, phone_number=None, amount=None, currency_code=None,
        ...
        if recipients is not None:
            ...
            try:
                schema = Schema([
                    {'phone_number': And(str, lambda s: validate_phone(s)),
            ...
            return self._make_request(url, 'POST', headers=self._headers,
                                      data=data, params=None, callback=callback)
